...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "fileViewer.openDefaultApp": "Open with default app",
    "fileViewer.revealInExplorer": "Reveal in Finder",
    "pluginsConfig.selectLocalFolder": "Select local plugin folder",
    "projectPicker.filterProjects": "Filter projects",
    "tabBar.openFiles": "Open files",
    "models.editor.baseUrl": "Base URL",
    "models.editor.apiKey": "API Key",
    "models.editor.api": "API",
    "models.editor.apiKeyHint": "Prefix with ! to run a shell command, or use an env var name",
    "models.editor.id": "ID *",
    "models.editor.name": "Name",
    "models.editor.displayName": "Display name",
    "models.editor.apiOverride": "API override",
    "models.editor.reasoningThinking": "Reasoning / thinking",
    "models.editor.imageInput": "Image input",
    "models.editor.deepseekCompat": "DeepSeek thinking compat",
    "models.editor.thinkingLevelMap": "Thinking level map",
    "models.editor.contextWindow": "Context window (tokens)",
    "models.editor.maxOutput": "Max output tokens",
    "models.editor.cost": "Cost (per million tokens)",
    "chat.thinkingLabelAuto": "Auto",
    "chat.thinkingLabelOff": "Off",
    "chat.thinkingLabelMinimal": "Minimal",
    "chat.thinkingLabelLow": "Low",
    "chat.thinkingLabelMedium": "Medium",
    "chat.thinkingLabelHigh": "High",
    "chat.thinkingLabelXhigh": "Extra high",
    "chat.thinkingLabelMax": "Max",
    "chat.toolsPresetOff": "No tools",
    "chat.toolsPresetDefault": "Default",
    "chat.toolsPresetFull": "All built-in tools",
    "tabBar.filesEmpty": "Files",
    "plugins.scopeGlobal": "Global",
    "plugins.scopeProject": "Project",
    "appSettings.footerLabel": "Settings",
  },
};
